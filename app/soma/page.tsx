    ...
    >
      ...
      >
        ...
        <div style={{ marginBottom: "2rem" }}>
          <p style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.22em", textTransform: "uppercase", color: "#C8907A", marginBottom: 8 }}>
            SOMA by MINDRA
          </p>
    ...
    >
      <div style={{ maxWidth: 1152, margin: "0 auto", padding: "1.25rem 1.5rem", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
          <span style={{ fontFamily: "var(--font-display), Georgia, serif", fontSize: 18, color: "#EEE8E4", letterSpacing: "-0.01em" }}>
            SOMA
          </span>
  ...
  return (
    <footer style={{ borderTop: "1px solid rgba(255,255,255,0.04)", padding: "2.5rem 1.5rem" }}>
      <div style={{ maxWidth: 1152, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
        <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
          <span style={{ fontFamily: "var(--font-display), Georgia, serif", fontSize: 14, color: "rgba(238,232,228,0.4)" }}>SOMA</span>
          <span style={{ fontSize: 9, fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", color: "#5A5060" }}>by MINDRA</span>
        </div>
    ...
    <>
      <style>{`
        ...
        @media (max-width: 600px) {
          ...
          /* Card — preview fade at bottom so it doesn't dominate */
          .soma-hero-card {
            max-height: 310px;
            overflow: hidden;
